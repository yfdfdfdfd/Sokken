...
export function QuestionCreateChildFromJSONTyped(json: any, ignoreDiscriminator: boolean): QuestionCreateChild {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function QuestionCreateChildToJSONTyped(value?: QuestionCreateChild | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
