  ...
  <div>
    ...
    <div v-else>
      <v-table class="v-table" v-if="child && child.length > 0">
        <thead>
          <tr>
            <th style="text-align: center; border: 1px solid black">問題集番号</th>
            <th style="text-align: center; border: 1px solid black">回答日時</th>
            <th style="text-align: center; border: 1px solid black">詳細</th>
          </tr>
        </thead>
        <tbody>
